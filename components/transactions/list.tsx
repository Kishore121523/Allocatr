              ...
              <div key={group.dateKey} className="space-y-3">
                ...
                <div className="space-y-3 sm:space-y-3">
                  {group.transactions.map((t) => (
                    <div key={t.id} className="flex flex-col sm:flex-row sm:items-center justify-between p-4 mx-2 rounded-lg border border-border/75 bg-accent/0 sm:border-transparent sm:bg-transparent sm:hover:bg-accent gap-3 sm:gap-4">
                      ...
                      <div className="flex items-center justify-between sm:justify-end sm:gap-4">
                        ...
                        <div className="flex items-center mr-[-6px] sm:mr-[-10px]">
